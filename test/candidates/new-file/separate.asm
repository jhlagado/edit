; Native ATOM historical experiment: new-file/separate
; Historical debugger names are recorded in separate.asm.symbols.json.
EDITORRP EQU $0000
EDITORRQ EQU $0000
...
; The independently dispatched first-save path shares only leaf helpers and
; failure tails with the established transaction.
EDITORSB:
            XOR  A
            LD   (EDITORSM),A
            CALL EDITORSL
