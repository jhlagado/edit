...
[`measure-replace.mjs`](../../tools/measure-replace.mjs).
...
The historical production proof passed its strict register-contract oracle. The
current ATOM-only production proof passes all isolated
